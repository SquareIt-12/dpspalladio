    ...
    <>
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          {/* Overlay */}
          <div
            className="absolute inset-0 backdrop-blur-[6px] bg-white/5 bg-opacity-50"
            onClick={() => setShowForm(false)}
          ></div>

          {/* Centered Popup */}
          <div className="relative bg-white/20 backdrop-blur-2xl shadow-5xl p-6 rounded-xl w-[400px] mx-auto border-2 border-black">
            {/* Logo */}
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => setShowForm(false)}>
                <X className="text-white absolute top-2 right-2 cursor-pointer w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <input
                ...
                placeholder="Name*"
                className="w-full mb-3 p-3 border border-[#C5A46D] rounded bg-orange-50 placeholder-[#C5A46D] focus:outline-none focus:ring-2 focus:ring-orange-400"
              />
              <input
                type="email"
                name="email"
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Mobile*"
                className="w-full mb-4 p-3 border border-[#C5A46D] rounded bg-orange-50 placeholder-[#C5A46D] focus:outline-none focus:ring-2 focus:ring-orange-400"
              />
              <button
                type="submit"
                className="w-full bg-gray-600 hover:bg-gray-800 cursor-pointer text-white font-semibold py-3 rounded transition-colors"
              >
                SUBMIT
              </button>
            </form>
